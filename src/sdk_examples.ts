...
export interface MultiDomainSdkReport {
  domainsSupported: number;
  committedDomains: number;
  ledgerAudit: boolean;
  replayRollbackRate: number;
  invalidCommitCount: number;
  scalarHardCalls: number;
  lifeHardCalls: number;
  gridHardCalls: number;
  sokobanHardCalls: number;
  operationsHardCalls: number;
  proofHardCalls: number;
  circuitHardCalls: number;
  moleculeHardCalls: number;
  codeHardCalls: number;
  robotHardCalls: number;
  chessHardCalls: number;
  routerTopDomain: string;
  routerScalarCounts: { accepted: number; rejected: number };
  routerLifeCounts: { accepted: number; rejected: number };
  routerSokobanCounts: { accepted: number; rejected: number };
  routerOperationsCounts: { accepted: number; rejected: number };
  routerProofCounts: { accepted: number; rejected: number };
  routerCircuitCounts: { accepted: number; rejected: number };
  routerMoleculeCounts: { accepted: number; rejected: number };
  routerCodeCounts: { accepted: number; rejected: number };
  routerRobotCounts: { accepted: number; rejected: number };
  routerChessCounts: { accepted: number; rejected: number };
}

export async function runMultiDomainSdkBenchmark(): Promise<MultiDomainSdkReport> {
...
function applyGridMacro(adapter: GridMacroAdapter, state: GridState, steps: GridStep[]): GridState {
