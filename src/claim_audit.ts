...
import { runRrlmMacroBenchmark, type RrlmMacroReport } from "./rrlm.js";
...
export interface ClaimAuditReport {
  ...
  supportedFailedKeys: string[];
  rejectedClaimId: string;
  rejectedStatus: string;
  rejectedFailedKeys: string[];
  overclaimDetected: boolean;
  nullResultRecorded: boolean;
  mechanismAblationRecorded: boolean;
  heldoutTraceEvaluation: boolean;
  sameCaseEqualBudget: boolean;
  verifierCallAccounting: boolean;
  learningEvaluationCertificateValid: boolean;
  learningEvaluationSupportsClaim: boolean;
  transferEvaluationCertificateValid: boolean;
  transferPositiveOverclaimRejected: boolean;
  transferGuardSnapshotValid: boolean;
  transferGuardBlocksNegativeTransfer: boolean;
  rrlmProposalCertificateValid: boolean;
  rrlmTransportCertificateValid: boolean;
  worldLearnerUpdateCertificateValid: boolean;
  worldLearnerDeltaCertificateValid: boolean;
  worldLearnerLineageCertificateValid: boolean;
  worldLearnerMergeCertificateValid: boolean;
  worldLearnerPartialOverlapMergeValid: boolean;
  worldRrlmProposalCertificateValid: boolean;
  ...
  supportedCertificateValid: boolean;
  rejectedCertificateValid: boolean;
  tamperDetected: boolean;
  invalidCommitCount: number;
  ledgerAudit: boolean;
  replayRollbackRate: number;
  supportedCertificateHash: string;
  rejectedCertificateHash: string;
}

export async function runClaimAuditBenchmark(): Promise<ClaimAuditReport> {
...
async function supportedCertificate(params: {
  ...
  mechanismAblationRecorded: boolean;
  nullResultRecorded: boolean;
  budgetCallGain: number;
  topkCallGain: number;
  learningEvalCertificateHash: string;
  transferCertificateHash: string;
  transferGuardSnapshotHash: string;
  transferGuardDecisionHash: string;
  rrlmProposalCertificateHash: string;
  rrlmTransportCertificateHash: string;
  transferSuccessDelta: number;
  rrlmVsNonReversibleGain: number;
  highRankGain: number;
}): Promise<ClaimCertificate> {
  return certifyClaim({
...
async function overclaimCertificate(rrlm: RrlmMacroReport): Promise<ClaimCertificate> {
  return certifyClaim({
...
function near(left: number, right: number, eps = 1e-12): boolean {
