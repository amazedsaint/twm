...
BRANCH_HISTORY_FRONTIER_CLAIM_BOUNDARY = (
    ...
    "drift quarantine, recency-weighted source freshness, restart-anchor backtracking, symmetry-transform transfer, pairwise-constraint transfer, confidence-bound support, Pareto-front transfer, outlier-filter transfer, provenance-guard transfer, branch pruning, branch diversity, budget allocation, trust-region radius transfer, "
    ...
    "Byzantine fault-tolerant protocol, consensus algorithm, security proof, or scientific-discovery claim."
)
...
def build_branch_history_frontier_result(
    ...
    report = BranchHistoryFrontierReport(
        ...
        learning=(
            ...
            "provenance-guard transfer twenty-seventh, receipt-bound branch pruning twenty-eighth, "
            "diversity-certified family coverage twenty-ninth, budget-allocation transfer thirtieth, "
            "no-good stop-rule abstention thirty-first, branch composition thirty-second, and "
            "retained-memory influence with matched ablation thirty-third."
        ),
    )
    claim = certify_claim(
        ...
        claim_text=(
            ...
            "query-policy, conflict-resolution, drift-quarantine, recency weighting, restart-anchor backtracking, symmetry-transform transfer, pairwise-constraint transfer, confidence-bound support, Pareto-front transfer, outlier filtering, provenance guarding, pruning, diversity, budget-allocation, "
        ...
        requirements=(
            requirement("exactly_thirty_three_branch_history_stages", report.stage_count == 33),
            requirement(
