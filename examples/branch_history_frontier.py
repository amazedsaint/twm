...
BRANCH_HISTORY_FRONTIER_CLAIM_BOUNDARY = (
    ...
    "estimation, model reliability assurance, or scientific-discovery claim."
)
...
def build_branch_history_frontier_result(
    ...
    report = BranchHistoryFrontierReport(
        ...
        learning=(
            ...
            "calibration transfer thirty-first, receipt-bound branch pruning thirty-second, "
            "diversity-certified family coverage thirty-third, budget-allocation transfer thirty-fourth, "
            "no-good stop-rule abstention thirty-fifth, branch composition thirty-sixth, and "
            "retained-memory influence with matched ablation thirty-seventh."
        ),
    )
    claim = certify_claim(
        ...
        requirements=(
            requirement("exactly_thirty_seven_branch_history_stages", report.stage_count == 37),
            requirement(
