...
export function oneHotUpdates(labels          , labelCount        )                  {
...
export function identityOutputMap(width        )                {
...
function normalizeMatrix(outputMap                           , width        )                {
  if (!outputMap) {
...
function jacobiEigenSymmetric(matrix               , maxSweeps = 80, tolerance = 1e-12)                                                 {
